...
Michael Dornbrook and Marc Blank

## Transcriber's notes

This document has been transcribed by [Tara
McGrew](https://github.com/taradinoc) from a [PDF maintained by the
DSpace@MIT](https://dspace.mit.edu/handle/1721.1/149570).  It attempts
...
[create an issue](https://github.com/taradinoc/mdl-primer/issues) or
[submit a pull request](https://github.com/taradinoc/mdl-primer/pulls).
...
<!-- TODO: Update the copyright discussion -->
